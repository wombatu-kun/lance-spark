...
/**
 * Sentinel V2 function for FTS phrase search: {@code lance_match_phrase(col, query [, slop])}.
 *
...
public final class LancePhraseFunction implements UnboundFunction {
  ...
  public String description() {
    return "FTS phrase search: lance_match_phrase(column, query [, slop]) -> BOOLEAN. "
